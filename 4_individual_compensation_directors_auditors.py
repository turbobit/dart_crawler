## 이사·감사의 개인별 보수현황(5억원 이상) 현황 수집 : https://opendart.fss.or.kr/guide/detail.do?apiGrpCd=DS002&apiId=2019012
...
output_file = data_dir / 'individual_compensation_directors_auditors.csv'
failed_file = data_dir / ('individual_compensation_directors_auditors' + '_failed_data.csv')
start_year = 2015
end_year = 2024
