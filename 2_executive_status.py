## 임원현황 수집 : https://opendart.fss.or.kr/guide/detail.do?apiGrpCd=DS002&apiId=2019010
...
output_file = data_dir / 'executive_status.csv'
failed_file = data_dir / ('executive_status' + '_failed_data.csv')
start_year = 2015
end_year = 2024
...
def get_executive_status(corp_code, year, report_code='11011'):
    """임원현황 데이터 가져오기"""
...
def main():    
    ...
    for i, corp in enumerate(corps):
        ...
        for year in range(start_year, end_year + 1):
            ...
            data = get_executive_status(corp['corp_code'], year)
