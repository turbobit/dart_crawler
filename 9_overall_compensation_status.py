## 이사·감사 전체의 보수현황(보수지급금액 - 유형별) 현황 수집 : https://opendart.fss.or.kr/guide/detail.do?apiGrpCd=DS002&apiId=2019013
...
output_file = data_dir / 'overall_compensation_status.csv'
failed_file = data_dir / ('overall_compensation_status' + '_failed_data.csv')
start_year = 2015
end_year = 2024
