## 이사·감사 전체의 보수현황(주주총회 승인금액) 현황 수집 : https://opendart.fss.or.kr/guide/detail.do?apiGrpCd=DS002&apiId=2019013
...
output_file = data_dir / 'overall_compensation_status_directors_auditors.csv'
failed_file = data_dir / ('overall_compensation_status_directors_auditors' + '_failed_data.csv')
start_year = 2015
end_year = 2024
