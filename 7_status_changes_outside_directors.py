## 개인별 보수지급 금액(5억이상 상위5인) 현황 수집 : https://opendart.fss.or.kr/guide/detail.do?apiGrpCd=DS002&apiId=2019013
...
output_file = data_dir / 'status_changes_outside_directors.csv'
failed_file = data_dir / ('status_changes_outside_directors' + '_failed_data.csv')
start_year = 2015
end_year = 2024
